...
class WaterHeatPump(IntegratedEnergySystem):
    ...
    def constraints_register(self, model: Model):
        ...
        3. 0≦水源热泵的强效制冷功率≦水源热泵设备数* (况2)制热量/制冷量,0≦水源热泵的强效制冷功率≦水源热泵强效制冷状态*bigNumber
        4. 0≦水源热泵的制热功率≦水源热泵设备数* (况3)制热量/制冷量,0≦水源热泵的制热功率≦水源热泵制热状态*bigNumber
        5. 0≦水源热泵的强效制热功率≦水源热泵设备数* (况4)制热量/制冷量,0≦水源热泵的强效制热功率≦水源热泵强效制热状态*bigNumber
        6. 制冷状态+强效制冷状态+制热状态+强效制热状态=1
...
class WaterEnergyStorage(IntegratedEnergySystem):
    ...
    def constraints_register(self, model: Model, register_period_constraints, day_node):
        ...
        5. 制热下设备数≦水蓄能机组总体积*制热模式下水蓄能罐的利用率
           ...
           制热下设备数≧0
           制热下设备数≧水蓄能机组总体积*制热模式下水蓄能罐的利用率-(1-水储能罐在制热状态下)*bigNumber
        6. 地源热泵下设备数≦水蓄能机组总体积*地源热泵模式下水蓄能罐的利用率
           地源热泵下设备数≦水储能罐在地源热泵状态下*bigNumber
           地源热泵下设备数≧0
           地源热泵下设备数≧水蓄能机组总体积*地源热泵模式下水蓄能罐的利用率-(1-水储能罐在地源热泵状态下)*bigNumber
