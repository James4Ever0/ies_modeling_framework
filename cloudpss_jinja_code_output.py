...
class 设备:
    ...
    def __init__(
        ...
        ## 设置设备额定运行参数 ##self.单个光伏板面积 = self.设备额定运行参数["单个光伏板面积"] 
        """单位：(m2) 设备额定运行参数"""
        ...
        ## 设置设备经济性参数 ##self.采购成本 = self.设备经济性参数["采购成本"] 
        """单位：(万元 / 台) 设备经济性参数"""
...
class 燃气轮机(设备):
    def __init__(
        ...
        ## 设置设备运行约束 ##self.最大烟气出口温度 = self.设备运行约束["最大烟气出口温度"]  + 274.15
...
class 燃气内燃机(设备):
    def __init__(
        ...
        ## 设置设备运行约束 ##self.最大热水出口温度 = self.设备运行约束["最大热水出口温度"]  + 274.15
        """单位：(kelvin) <- (degree_Celsius) 设备运行约束"""
...
class 蒸汽轮机(设备):
    def __init__(
        ...
        ## 设置设备运行约束 ##self.最大蒸汽进口温度 = self.设备运行约束["最大蒸汽进口温度"]  + 274.15
        """单位：(kelvin) <- (degree_Celsius) 设备运行约束"""
...
class 燃气蒸汽锅炉(设备):
    def __init__(
        ...
        ## 设置设备运行约束 ##self.最大蒸汽出口温度 = self.设备运行约束["最大蒸汽出口温度"]  + 274.15
        """单位：(kelvin) <- (degree_Celsius) 设备运行约束"""
...
class 热管式太阳能集热器(设备):
    def __init__(
        ...
        ## 设置设备额定运行参数 ##self.单个集热器面积 = self.设备额定运行参数["单个集热器面积"] 
        """单位：(m2) 设备额定运行参数"""
...
class 电压缩制冷机(设备):
    def __init__(
        ...
        ## 设置设备运行约束 ##self.最大冷水出口温度 = self.设备运行约束["最大冷水出口温度"]  + 274.15
        """单位：(kelvin) <- (degree_Celsius) 设备运行约束"""
        self.最小冷水出口温度 = self.设备运行约束["最小冷水出口温度"]  + 274.15
        """单位：(kelvin) <- (degree_Celsius) 设备运行约束"""
        self.最大冷水进口温度 = self.设备运行约束["最大冷水进口温度"]  + 274.15
...
class 热水吸收式制冷机(设备):
    def __init__(
        ...
        ## 设置设备运行约束 ##self.最大热源出口温度 = self.设备运行约束["最大热源出口温度"]  + 274.15
        """单位：(kelvin) <- (degree_Celsius) 设备运行约束"""
...
class 蓄热电锅炉(设备):
    def __init__(
        ...
        ## 设置设备额定运行参数 ##self.蓄热效率 = self.设备额定运行参数["蓄热效率"]  * 0.01
        """单位：(one) <- (percent) 设备额定运行参数"""
...
class 蓄电池(设备):
    def __init__(
        ...
        ## 设置设备额定运行参数 ##self.充电效率 = self.设备额定运行参数["充电效率"]  * 0.01
        """单位：(one) <- (percent) 设备额定运行参数"""
...
class 变压器(设备):
    def __init__(
        ...
        ## 设置设备运行约束 ##self.最大非标准变比 = self.设备运行约束["最大非标准变比"] 
        """单位：(p_u_) 设备运行约束"""
...
class 传输线(设备):
    def __init__(
        ...
        ## 设置设备额定运行参数 ##self.单位长度正序电抗 = self.设备额定运行参数["单位长度正序电抗"] 
...
class 换热器(设备):
    def __init__(
        ...
        ## 设置设备运行约束 ##self.最大热流体出口温度 = self.设备运行约束["最大热流体出口温度"]  + 274.15
        """单位：(kelvin) <- (degree_Celsius) 设备运行约束"""
...
class 管道(设备):
    def __init__(
        ...
        ## 设置设备经济性参数 ##self.采购成本 = self.设备经济性参数["采购成本"]  * 0.1
...
class 光伏_建模仿真(设备):
    def __init__(
        ...
        ## 设置设备额定运行参数 ##self.光伏板面积 = self.设备额定运行参数["光伏板面积"] 
        """单位：(m2) 设备额定运行参数"""
        self.光电转换效率 = self.设备额定运行参数["光电转换效率"]  * 0.01
        """单位：(one) <- (percent) 设备额定运行参数"""
...
class 燃气轮机_建模仿真(设备):
    def __init__(
        ...
        ## 设置设备额定运行参数 ##self.局部压降系数  = self.设备额定运行参数["局部压降系数 "]  * 1.00413490930961
        """单位：(megapascal * 年 ** 2 / kilometer ** 6) <- (kilopascal * second ** 2 / meter ** 6) 设备额定运行参数"""
        self.功率因数 = self.设备额定运行参数["功率因数"] 
        """设备额定运行参数"""
        
        
        ## 设置设备运行约束 ##self.最小供水温度  = self.设备运行约束["最小供水温度 "]  + 274.15
        """单位：(kelvin) <- (degree_Celsius) 设备运行约束"""
...
class 蒸汽轮机_建模仿真(设备):
    def __init__(
        ...
        ## 设置设备额定运行参数 ##self.额定蒸汽进口温度 = self.设备额定运行参数["额定蒸汽进口温度"]  + 274.15
...
class 储水罐_建模仿真(设备):
    def __init__(
        ...
        ## 设置设备额定运行参数 ##self.入口侧局部压降系数 = self.设备额定运行参数["入口侧局部压降系数"]  * 1.00413490930961
        """单位：(megapascal * 年 ** 2 / kilometer ** 6) <- (kilopascal * second ** 2 / meter ** 6) 设备额定运行参数"""
        self.出口侧局部压降系数 = self.设备额定运行参数["出口侧局部压降系数"]  * 1.00413490930961
        """单位：(megapascal * 年 ** 2 / kilometer ** 6) <- (kilopascal * second ** 2 / meter ** 6) 设备额定运行参数"""
...
class 变压器_建模仿真(设备):
    def __init__(
        ...
        ## 设置设备额定运行参数 ##self.变压器非标准变比 = self.设备额定运行参数["变压器非标准变比"] 
        """单位：(p_u_) 设备额定运行参数"""
...
class 传输线_建模仿真(设备):
    def __init__(
        ...
        ## 设置设备额定运行参数 ##self.单位长度电抗 = self.设备额定运行参数["单位长度电抗"] 
...
class 离心泵_建模仿真(设备):
    def __init__(
        ...
        ## 设置设备额定运行参数 ##self.额定转速  = self.设备额定运行参数["额定转速 "]  * 0.10471975511965977
