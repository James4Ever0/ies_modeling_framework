...
class PV(IGES):
    ...
    def __init__(
        self, num_h, mdl: Model, pv_set_max, set_price, ha0, eff, set_name="PV"
    ):
        IGES(set_name)
        PV.index += 1
...
class Diesel(IGES):
    ...
    def __init__(
        self, num_h, mdl: Model, diesel_set_max, set_price, run_price, set_name="diesel"
    ):
        IGES(set_name)
        Diesel.index += 1
        self.num_h = num_h
...
class Dgl(IGES):
    ...
    def __init__(
        self, num_h, mdl: Model, dgl_set_max, dgl_price, ele_price, eff, set_name="dgl"
    ):
        IGES(set_name)
        Dgl.index += 1
        self.num_h = num_h
