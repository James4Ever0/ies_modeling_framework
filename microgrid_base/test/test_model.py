...
def test_BinVarMultiplySingle(model_wrapper: ModelWrapper, 测试设备模型: 设备模型):
...
def test_VarMultiplySingle(model_wrapper: ModelWrapper, 测试设备模型: 设备模型):
...
def test_单表达式生成指示变量(model_wrapper: ModelWrapper, 测试设备模型: 设备模型):
...
def test_Piecewise(model_wrapper: ModelWrapper, 测试设备模型: 设备模型):
...
def test_双向变流器(model_wrapper: ModelWrapper, 测试双向变流器模型: 双向变流器模型):
    ...


@pytest.mark.parametrize("input, output", [])
def test_风力发电(model_wrapper: ModelWrapper, 测试风力发电模型: 风力发电模型):
    ...
