...
class 规划结果详情(BaseModel):
    ...
    def export(deviceModel: 设备模型协议, deviceSimulationResult: Union[柴油仿真结果, 电负荷仿真结果, 光伏发电仿真结果, 风力发电仿真结果, 柴油发电仿真结果, 锂电池仿真结果, 变压器仿真结果, 变流器仿真结果, 双向变流器仿真结果, 传输线仿真结果], timeParam:float):
        params = {}
...
class 规划方案概览(BaseModel):
    ...
    @staticmethod
    def export(planningResultList: List[规划结果详情], simulationResultList: List[仿真结果], totalAnnualFee:float, planType: str): # totalAnnualFee is equivalent to our "financial" objective
        ...
        remainedKeys = getRequiredKeysSetFromDataModel(规划结果详情).difference(set(params.keys()))
