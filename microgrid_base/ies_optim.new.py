...
class 分月电价(BaseModel, 电价转换):
    PriceList:Tuple[float, float, float, float, float, float, float, float, float, float, float, float] = Field(title = f"长度为{每年月数}的价格数组", description = "单位: 元/kWh")
...
class 分时电价(BaseModel, 电价转换):
    PriceList:Tuple[float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float] = Field(title = f"长度为{每天小时数}的价格数组", description = "单位: 元/kWh")
...
class 分时分月电价(BaseModel, 电价转换):
    PriceStruct:Tuple[分时电价, 分时电价, 分时电价, 分时电价, 分时电价, 分时电价, 分时电价, 分时电价, 分时电价, 分时电价, 分时电价, 分时电价] = Field(title = f"长度为{每年月数}的分时电价数组", description = "单位: 元/kWh")
...
class 阶梯电价(BaseModel):
    PriceStruct: conlist(计价阶梯, min_items=1) = Field(title = "长度不定的计价阶梯列表", description = "单位: 元/kWh")
...
class 分时阶梯电价(BaseModel):
    PriceStructList:Tuple[阶梯电价, 阶梯电价, 阶梯电价, 阶梯电价, 阶梯电价, 阶梯电价, 阶梯电价, 阶梯电价, 阶梯电价, 阶梯电价, 阶梯电价, 阶梯电价, 阶梯电价, 阶梯电价, 阶梯电价, 阶梯电价, 阶梯电价, 阶梯电价, 阶梯电价, 阶梯电价, 阶梯电价, 阶梯电价, 阶梯电价, 阶梯电价] = Field(title = f"长度为{每天小时数}的阶梯电价数组", description = "单位: 元/kWh")
...
class 柴油信息(设备基础信息):
    ...
    Price : Tuple[confloat(gt=0), constr(min_length=1)] = Field(title = "Price", description="格式: [数值,单位]")
    """
    格式: [数值,单位]
    """
    热值 : Tuple[confloat(gt=0), constr(min_length=1)] = Field(title = "热值", description="格式: [数值,单位]")
    """
    格式: [数值,单位]
    """
    CO2 : Tuple[confloat(gt=0), constr(min_length=1)] = Field(title = "CO2", description="格式: [数值,单位]")
    """
    格式: [数值,单位]
    """
    NOX : Tuple[confloat(gt=0), constr(min_length=1)] = Field(title = "NOX", description="格式: [数值,单位]")
    """
    格式: [数值,单位]
    """
    SO2 : Tuple[confloat(gt=0), constr(min_length=1)] = Field(title = "SO2", description="格式: [数值,单位]")
    """
    格式: [数值,单位]
    """
...
class 电负荷信息(设备基础信息):
    ...
    MaxEnergyConsumption: Union[None, confloat(gt=0)] = Field(default = None, title = "最大消耗功率", description = '单位: kW\n用于典型日下计算变压器容量')
    """
    单位: kW
    """
...
class 光伏发电信息(设备信息):
    ...
    PowerConversionEfficiency: confloat(ge=0) = Field(title = "电电转换效率", description =   "名称: 电电转换效率\n单位: percent")
    """
    名称: 电电转换效率
    单位: percent
    """
    ...
    PowerDeltaLimit: confloat(ge=0) = Field(title = "发电爬坡率", description =   "名称: 发电爬坡率\n单位: percent/s")
    """
    名称: 发电爬坡率
    单位: percent/s
    """

    CostPerKilowatt: confloat(ge=0) = Field(title = "采购成本", description =   "名称: 采购成本\n单位: 万元/kWp")
    """
    名称: 采购成本
    单位: 万元/kWp
    """

    CostPerYearPerKilowatt: confloat(ge=0) = Field(title = "固定维护成本", description =   "名称: 固定维护成本\n单位: 万元/(kWp*年)")
    """
    名称: 固定维护成本
    单位: 万元/(kWp*年)
    """

    VariationalCostPerWork: confloat(ge=0) = Field(title = "可变维护成本", description =   "名称: 可变维护成本\n单位: 元/kWh")
    """
    名称: 可变维护成本
    单位: 元/kWh
    """
    ...
    BuildCostPerKilowatt: confloat(ge=0) = Field(title = "建设费用系数", description =   "名称: 建设费用系数\n单位: 万元/kWp")
    """
    名称: 建设费用系数
    单位: 万元/kWp
    """

    BuildBaseCost: confloat(ge=0) = Field(title = "建设费用基数", description =   "名称: 建设费用基数\n单位: 万元")
    """
    名称: 建设费用基数
    单位: 万元
    """

    MaxInstallArea: confloat(ge=0) = Field(title = "最大安装面积", description =   "名称: 最大安装面积\n单位: m2")
    """
    名称: 最大安装面积
    单位: m2
    """

    MinInstallArea: confloat(ge=0) = Field(title = "最小安装面积", description =   "名称: 最小安装面积\n单位: m2")
    """
    名称: 最小安装面积
    单位: m2
    """
...
class 风力发电信息(设备信息):
    ...
    RatedWindSpeed: confloat(ge=0) = Field(title = "额定风速", description =   "名称: 额定风速\n单位: m/s")
    """
    名称: 额定风速
    单位: m/s
    """
    ...
    MaxDeviceCount: confloat(ge=0) = Field(title = "最大安装台数", description =   "名称: 最大安装台数\n单位: 台")
    """
    名称: 最大安装台数
    单位: 台
    """

    MinDeviceCount: confloat(ge=0) = Field(title = "最小安装台数", description =   "名称: 最小安装台数\n单位: 台")
    """
    名称: 最小安装台数
    单位: 台
    """
...
class 柴油发电信息(设备信息):
    ...
    PowerStartupLimit: confloat(ge=0) = Field(title = "启动功率百分比", description =   "名称: 启动功率百分比\n单位: percent")
    """
    名称: 启动功率百分比
    单位: percent
    """
    ...
    CostPerMachine: confloat(ge=0) = Field(title = "采购成本", description =   "名称: 采购成本\n单位: 万元/台")
    """
    名称: 采购成本
    单位: 万元/台
    """

    CostPerYearPerMachine: confloat(ge=0) = Field(title = "固定维护成本", description =   "名称: 固定维护成本\n单位: 万元/(台*年)")
    """
    名称: 固定维护成本
    单位: 万元/(台*年)
    """
    ...
    BuildCostPerMachine: confloat(ge=0) = Field(title = "建设费用系数", description =   "名称: 建设费用系数\n单位: 万元/台")
    """
    名称: 建设费用系数
    单位: 万元/台
    """
    ...
    DieselToPower_Load : List[Tuple[confloat(gt=0),confloat(ge=0)]] = Field(title = "燃油消耗率_负载率", description=   "DieselToPower: 燃油消耗率\n单位: L/kWh\nLoad: 负载率\n单位: percent")
    """
    DieselToPower: 燃油消耗率
    单位: L/kWh
...
class 锂电池信息(设备信息):
    ...
    BatteryDeltaLimit: confloat(ge=0) = Field(title = "电池充放电倍率", description =   "名称: 电池充放电倍率\n单位: 1/hour")
    """
    名称: 电池充放电倍率
    单位: 1/hour
    """

    ChargeEfficiency: confloat(ge=0) = Field(title = "充能效率", description =   "名称: 充能效率\n单位: percent")
    """
    名称: 充能效率
    单位: percent
    """
    ...
    DischargeEfficiency: confloat(ge=0) = Field(title = "放能效率", description =   "名称: 放能效率\n单位: percent")
    """
    名称: 放能效率
    单位: percent
    """
    ...
    BatteryStorageDecay: confloat(ge=0) = Field(title = "存储衰减", description =   "名称: 存储衰减\n单位: percent/hour")
    """
    名称: 存储衰减
    单位: percent/hour
    """

    LifetimeCycleCount: confloat(ge=0) = Field(title = "等效完全循环次数", description =   "名称: 等效完全循环次数\n单位: 次")
    """
    名称: 等效完全循环次数
    单位: 次
    """
    ...
    CostPerCapacity: confloat(ge=0) = Field(title = "采购成本", description =   "名称: 采购成本\n单位: 万元/kWh")
    """
    名称: 采购成本
    单位: 万元/kWh
    """

    CostPerYearPerCapacity: confloat(ge=0) = Field(title = "固定维护成本", description =   "名称: 固定维护成本\n单位: 万元/(kWh*年)")
    """
    名称: 固定维护成本
    单位: 万元/(kWh*年)
    """
    ...
    BuildCostPerCapacity: confloat(ge=0) = Field(title = "建设费用系数", description =   "名称: 建设费用系数\n单位: 万元/kWh")
    """
    名称: 建设费用系数
    单位: 万元/kWh
    """
    ...
    MaxTotalCapacity: confloat(ge=0) = Field(title = "最大设备容量", description =   "名称: 最大设备容量\n单位: kWh")
    """
    名称: 最大设备容量
    单位: kWh
    """

    MinTotalCapacity: confloat(ge=0) = Field(title = "最小设备容量", description =   "名称: 最小设备容量\n单位: kWh")
    """
    名称: 最小设备容量
    单位: kWh
    """
...
class 变压器信息(设备信息):
    ...
    PowerParameter: confloat(ge=0) = Field(title = "功率因数", description =   "名称: 功率因数\n单位: one")
    """
    名称: 功率因数
    单位: one
    """

    LoadRedundancyParameter: confloat(ge=0) = Field(title = "变压器冗余系数", description =   "名称: 变压器冗余系数\n单位: one")
    """
    名称: 变压器冗余系数
    单位: one
    """
...
class 传输线信息(设备信息):
    ...
    PowerTransferDecay: confloat(ge=0) = Field(title = "能量衰减系数", description =   "名称: 能量衰减系数\n单位: kW/km")
    """
    名称: 能量衰减系数
    单位: kW/km
    """

    CostPerKilometer: confloat(ge=0) = Field(title = "采购成本", description =   "名称: 采购成本\n单位: 万元/km")
    """
    名称: 采购成本
    单位: 万元/km
    """

    CostPerYearPerKilometer: confloat(ge=0) = Field(title = "维护成本", description =   "名称: 维护成本\n单位: 万元/(km*年)")
    """
    名称: 维护成本
    单位: 万元/(km*年)
    """
    ...
    BuildCostPerKilometer: confloat(ge=0) = Field(title = "建设费用系数", description =   "名称: 建设费用系数\n单位: 万元/km")
    """
    名称: 建设费用系数
    单位: 万元/km
    """
...
class ModelWrapper:
    ...
    def __init__(self, model:Optional[ConcreteModel]=None, cloned:bool = False):
        ...
        self.varNameToSubmodelName = cast(Dict[str, str], defaultdict(lambda: "unknownSubmodelName"))
        ...
        self.varNameToSubmodelClassName = cast(Dict[str, str], defaultdict(lambda: "unknownSubmodelClassName"))
        self.submodelClassNameToVarName = cast(Dict[str, List[str]], defaultdict(lambda: []))
    ...
    def setSubmodelName(self, submodelName:str):
        assert isinstance(submodelName, str), f"submodelName must be a string!\nsubmodelName: {repr(submodelName)}"
        ...
        self.submodelNameToVarName[submodelName] = self.submodelNameToVarName.get(submodelName, []) 
    ...
    def setSubmodelClassName(self, submodelClassName:str):
        assert isinstance(submodelClassName, str), f"submodelClassName must be a string!\nsubmodelClassName: {repr(submodelClassName)}"
        ...
        self.submodelClassNameToVarName[submodelClassName] = self.submodelClassNameToVarName.get(submodelClassName, []) 
    ...
    def Constraint(self,  *args, **kwargs):
        ...
        assert getattr(self.model,name, None) is None, f"错误: 不能设置两次相同的变量名称\n重复变量: { name }"
...
class 设备模型:
    ...
    def 变量列表_带指示变量(self, varName:str,  exprList:list=None, within= Reals, mrange:range=None) -> POSNEG:
        ...
        b_pos = self.变量列表(self.getSpecialVarName(varName), within = Boolean, mrange = mrange)
        x_pos = self.变量列表(self.getSpecialVarName(varName), within = NonNegativeReals, mrange = mrange)

        self.RangeConstraint(b_pos, x_pos, lambda x,y: x*self.BigM >= y, mrange = mrange)
        b_neg = self.变量列表(self.getSpecialVarName(varName), within = Boolean, mrange = mrange)
        x_neg = self.变量列表(self.getSpecialVarName(varName), within = NonNegativeReals, mrange = mrange)

        self.RangeConstraint(b_neg, x_neg, lambda x,y: x*self.BigM >= y, mrange = mrange)
    ...
    def breakdownExpression(expr):
        ...
        assert expr_type != pyomo.core.base.var.IndexedVar, f"Expression: {repr(expr)[:200]}\nInvalid expression type."
...
class 光伏发电模型(设备模型):
    ...
    def constraints_register(self):
        ...
        self.总可变维护成本年化 = ((self.SumRange(self.电输出)) / self.计算参数.迭代步数) * 每年小时数 * self.VariationalCostPerWork
...
class 风力发电模型(设备模型):
    ...
    def constraints_register(self):
        ...
        self.总固定维护成本 = self.CostPerYearPerKilowatt * (self.DeviceCount * self.RatedPower)
        self.总建设费用 = self.BuildCostPerKilowatt * (self.DeviceCount * self.RatedPower) + self.BuildBaseCost
...
class 柴油发电模型(设备模型):
    def __init__(self, PD:dict, mw: ModelWrapper, 计算参数实例: 计算参数, 设备ID: 柴油发电ID, 设备信息: 柴油发电信息):
        ...
        self.PD[self.设备ID.燃料接口] = self.ports['燃料接口'] = self.燃料接口 = self.变量列表("燃料接口", within=NonPositiveReals)
        """
        类型: 柴油输入
        """
    ...
    def constraints_register(self):
        ...
        if self.计算参数.计算步长 == "秒"  and self.设备信息.unitPlanningAlgorithmSelection != 油耗规划算法.最佳:
            总最大功率 = self.RatedPower * self.DeviceCount
            最大功率变化 = 总最大功率 * self.PowerDeltaLimit / 100
...
class 锂电池模型(设备模型):
    ...
    def constraints_register(self):
        ...
        self.总固定维护成本 = self.CostPerYearPerCapacity * (self.DeviceCount * self.RatedCapacity)
        self.总建设费用 = self.BuildCostPerCapacity * (self.DeviceCount * self.RatedCapacity) + self.BuildBaseCost

        self.总固定成本年化 = (self.总采购成本 + self.总建设费用) * self.年化率 + self.总固定维护成本 

        self.总可变维护成本年化 = ((计算范围内总平均放电功率*self.计算参数.迭代步数) / self.计算参数.迭代步数) * 每年小时数 * self.VariationalCostPerWork
        # avg_power * 8760 = annual_work
...
class 变压器模型(设备模型):
    def __init__(self, PD:dict, mw: ModelWrapper, 计算参数实例: 计算参数, 设备ID: 变压器ID, 设备信息: 变压器信息):
        ...
        self.PD[self.设备ID.电输入] = self.ports['电输入'] = self.电输入 = self.变量列表("电输入", within=Reals)
        """
        类型: 电母线输入
        """

        self.PD[self.设备ID.电输出] = self.ports['电输出'] = self.电输出 = self.变量列表("电输出", within=Reals)
        """
        类型: 变压器输出
        """
    ...
    def constraints_register(self):
        ...
        self.总可变维护成本年化 = (((self.SumRange(self.PowerInput_.x_neg) + self.SumRange(self.PowerOutput_.x_neg))) / self.计算参数.迭代步数) * 每年小时数 * self.VariationalCostPerWork
        # avg_power * 8760 = annual_work
...
class 变流器模型(设备模型):
    def __init__(self, PD:dict, mw: ModelWrapper, 计算参数实例: 计算参数, 设备ID: 变流器ID, 设备信息: 变流器信息):
        ...
        self.PD[self.设备ID.电输入] = self.ports['电输入'] = self.电输入 = self.变量列表("电输入", within=NonPositiveReals)
        """
        类型: 变流器输入
        """
    ...
    def constraints_register(self):
        ...
        self.总可变维护成本年化 = ((-self.SumRange(self.电输入)) / self.计算参数.迭代步数) * 每年小时数 * self.VariationalCostPerWork
        # avg_power * 8760 = annual_work
...
class 双向变流器模型(设备模型):
    ...
    def constraints_register(self):
        ...
        self.总可变维护成本年化 = (((self.SumRange(self.储能端_.x_neg)+self.SumRange(self.线路端_.x_neg))) / self.计算参数.迭代步数) * 每年小时数 * self.VariationalCostPerWork
        # avg_power * 8760 = annual_work
...
class 电负荷模型(设备模型):
    def __init__(self, PD:dict, mw: ModelWrapper, 计算参数实例: 计算参数, 设备ID: 电负荷ID, 设备信息: 电负荷信息):
        ...
        self.PD[self.设备ID.电接口] = self.ports['电接口'] = self.电接口 = self.变量列表("电接口", within=NonPositiveReals)
        """
        类型: 负荷电输入
        """
    ...
    def constraints_register(self):
        ...
        getTimeInDay = lambda index: index if self.计算参数.计算步长 == "小时" else self.计算参数.分时计价开始时间点 + 每天小时数*convertMonthToDays(self.计算参数.分时计价开始月份) + (index/每小时秒数)

        self.IncomeRates = [self.PriceModel.getFee(power, getTimeInDay(index)) for index, power in enumerate(self.电接口.values())] # negative, means income
        punishmentRates = [0]
        ...
        if self.设备信息.LoadType == 负荷类型.Normal:
            ...
            self.RangeConstraintMulti(self.电接口, self.UnsatisfiedEnergyConsumption, self.设备信息.EnergyConsumption,expression =  lambda x,y,z: x == -(z-y))
            ...
            self.RangeConstraintMulti(self.电接口, expression = lambda x: -x>=self.设备信息.Pmin)
            self.RangeConstraintMulti(self.电接口, expression = lambda x: -x<=self.设备信息.Pmax)
        elif self.设备信息.LoadType == 负荷类型.Interruptable:
            self.RangeConstraintMulti(self.电接口, self.Interrupted, expression = lambda x,y : -x==self.设备信息.Pmax*(1-y))
        elif self.设备信息.LoadType == 负荷类型.InterruptableAndFlexible:
            self.RangeConstraintMulti(self.电接口, self.Interrupted, expression = lambda x,y : -x>=self.设备信息.Pmin*(1-y))
            self.RangeConstraintMulti(self.电接口, self.Interrupted, expression = lambda x,y : -x<=self.设备信息.Pmax*(1-y))
        else:
...
class 规划结果详情_翻译(BaseModel):
    ...
    purchasingCost: float = Field(title="purchasingCost", description='单位: 万元\n对应字段: 设备采购成本')
    """
    单位: 万元
    对应字段: 设备采购成本
    """

    maintenanceFee: float = Field(title="maintenanceFee", description='单位: 万元\n对应字段: 设备年维护费')
    """
    单位: 万元
    对应字段: 设备年维护费
    """
...
class 规划结果详情(BaseModel):
    ...
    def export(cls, deviceModel: 设备模型协议, deviceSimulationResult, timeParam:float):
        ...
        params['机组年启动次数'] = value(getattr_with_ellipsis_fallback(deviceModel,'机组年启动次数', cmath.nan))
        params['机组年运行时间'] = value(getattr_with_ellipsis_fallback(deviceModel,'机组年运行时间', cmath.nan))
...
class 规划方案概览_翻译(BaseModel):
    ...
    annualizedCost: float = Field(title="annualizedCost", description='单位: 万元\n对应字段: 年化费用')
    """
    单位: 万元
    对应字段: 年化费用
    """
    ...
    hydrogenLoad: float = Field(title="hydrogenLoad", description='单位: Nm³\n对应字段: 年氢气负荷')
    """
    单位: Nm³
    对应字段: 年氢气负荷
    """
...
class 母线节点(节点基类):
    type: Literal['母线']
    conn: conlist(constr(min_length=1), min_items=2)  = Field(title = '母线连接线类型列表', description = '包括连接到母线上的连接线和合并线类型')# connection/merge types to literal.
...
class 设备节点基类(节点基类):
    type: Literal['设备']
    ports:Dict[constr(min_length=1),设备接口映射] = Field(title = "设备接口映射", description = "描述设备所对应接口的类型和接口ID")
...
class 双向变流器节点(设备节点基类):
    subtype: Literal['双向变流器', *deviceSubtypeAlias.get('双向变流器', [])] = Field(title = "节点次类型")
...
class mDict(BaseModel):
    ...
    graph:计算参数 = Field(
        ...
        description="仿真和优化所需的模型参数字典", example = {
            ...
            "计算类型": "设计规划",
            "风速": [], "光照":[],"气温":[] ,"年利率":0.1})
    nodes:conlist(Union[锚点节点,柴油节点,电负荷节点,光伏发电节点,风力发电节点,柴油发电节点,锂电池节点,变压器节点,变流器节点,双向变流器节点,传输线节点,母线节点,连线节点], min_items=5) = Field(
        title="节点",
