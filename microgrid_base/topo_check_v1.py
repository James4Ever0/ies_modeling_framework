...
母线类型 = ["可连接供电端母线", "可连接电母线", "可连接电储能端母线", "可连接负荷电母线", "可连接柴油母线"]
...
合并线类型 = ["可合并电母线", "可合并负荷电母线", "可合并电储能端母线", "可合并供电端母线", "可合并柴油母线"]
...
class 拓扑图:
    ...
    # def resolve_port_to_adder_by_id_and_subtype(self, adder, right_id, right_subtype):
    #     if right_subtype.endswith("输入输出"):
    #         adder["IO"].append(right_id)
    #     elif right_subtype.endswith("输入"):
    #         adder["output"].append(right_id)
