...
设备接口名称集合 = {
    ...
    "蒸汽负荷": {"蒸汽接口"},
    "氢负荷": {"氢气接口"},
    "燃气发电机": {"燃料接口", "缸套水余热接口", "电接口", "高温烟气余热接口"},
    "蒸汽轮机": {"蒸汽接口", "电接口"},
    ...
    "水冷冷却塔": {"水接口", "冷源接口", "电接口"},
    "余热热源": {"热源接口"},
    "浅层双源四工况热泵": {"制冷接口", "冷源接口", "制热接口", "电接口", "蓄冷接口", "热源接口", "蓄热接口"},
    "中深层双源四工况热泵": {"制冷接口", "冷源接口", "制热接口", "电接口", "蓄冷接口", "热源接口", "蓄热接口"},
    "浅层双源三工况热泵": {"制冷接口", "冷源接口", "制热接口", "电接口", "制冰接口", "热源接口"},
    "中深层双源三工况热泵": {"制冷接口", "冷源接口", "制热接口", "电接口", "制冰接口", "热源接口"},
    "水冷螺杆机": {"制冷接口", "蓄冷接口", "冷源接口", "电接口"},
    "双工况水冷螺杆机组": {"制冷接口", "冷源接口", "制冰接口", "电接口"},
    "吸收式燃气热泵": {"燃料接口", "制热接口"},
    "空气源热泵": {"制冷接口", "制热接口", "电接口", "蓄冷接口", "蓄热接口"},
    "蒸汽溴化锂": {"制冷接口", "冷源接口", "蒸汽接口"},
    "热水溴化锂": {"制冷接口", "冷源接口", "热水接口"},
    "电热水锅炉": {"制热接口", "电接口"},
    "电蒸汽锅炉": {"蒸汽接口", "电接口"},
    "天然气热水锅炉": {"燃料接口", "制热接口"},
    "天然气蒸汽锅炉": {"蒸汽接口", "燃料接口"},
    ...
    "输水管道": {"输入接口", "输出接口", "电接口"},
    "蒸汽管道": {"输入接口", "输出接口"},
    "复合输水管道": {"电接口", "冷输出接口", "热输出接口", "热输入接口", "冷输入接口"},
    "水水换热器": {"输入接口", "输出接口"},
    "复合水水换热器": {"冷输出接口", "热输出接口", "冷输入接口", "热输入接口"},
    "气水换热器": {"输入接口", "输出接口"},
}
...
class 变压器(设备):
    def __init__(self, topo: 拓扑图, **kwargs):
        super().__init__(
            topo=topo, device_type="变压器", port_definition={"电输出", "电输入"}, **kwargs
        )
...
class 双向变压器(设备):
    def __init__(self, topo: 拓扑图, **kwargs):
        super().__init__(
            topo=topo, device_type="双向变压器", port_definition={"电输出", "电输入"}, **kwargs
        )
...
class 变流器(设备):
    def __init__(self, topo: 拓扑图, **kwargs):
        super().__init__(
            topo=topo, device_type="变流器", port_definition={"电输出", "电输入"}, **kwargs
        )
...
class 双向变流器(设备):
    def __init__(self, topo: 拓扑图, **kwargs):
        super().__init__(
            topo=topo, device_type="双向变流器", port_definition={"线路端", "储能端"}, **kwargs
        )
...
class 燃气发电机(设备):
    def __init__(self, topo: 拓扑图, **kwargs):
        super().__init__(
            topo=topo,
            device_type="燃气发电机",
            port_definition={"燃料接口", "缸套水余热接口", "电接口", "高温烟气余热接口"},
            **kwargs,
        )
...
class 浅层双源四工况热泵(设备):
    def __init__(self, topo: 拓扑图, **kwargs):
        super().__init__(
            ...
            port_definition={"制冷接口", "冷源接口", "制热接口", "电接口", "蓄冷接口", "热源接口", "蓄热接口"},
            **kwargs,
        )
...
class 浅层双源三工况热泵(设备):
    def __init__(self, topo: 拓扑图, **kwargs):
        super().__init__(
            ...
            port_definition={"制冷接口", "冷源接口", "制热接口", "电接口", "制冰接口", "热源接口"},
            **kwargs,
        )
...
class 水冷螺杆机(设备):
    def __init__(self, topo: 拓扑图, **kwargs):
        super().__init__(
            topo=topo,
            device_type="水冷螺杆机",
            port_definition={"制冷接口", "蓄冷接口", "冷源接口", "电接口"},
            **kwargs,
        )
...
class 双工况水冷螺杆机组(设备):
    def __init__(self, topo: 拓扑图, **kwargs):
        super().__init__(
            ...
            port_definition={"制冷接口", "冷源接口", "制冰接口", "电接口"},
            **kwargs,
        )
...
class 吸收式燃气热泵(设备):
    def __init__(self, topo: 拓扑图, **kwargs):
        super().__init__(
            topo=topo, device_type="吸收式燃气热泵", port_definition={"燃料接口", "制热接口"}, **kwargs
        )
...
class 空气源热泵(设备):
    def __init__(self, topo: 拓扑图, **kwargs):
        super().__init__(
            topo=topo,
            device_type="空气源热泵",
            port_definition={"制冷接口", "制热接口", "电接口", "蓄冷接口", "蓄热接口"},
            **kwargs,
        )
...
class 蒸汽溴化锂(设备):
    def __init__(self, topo: 拓扑图, **kwargs):
        super().__init__(
            topo=topo,
            device_type="蒸汽溴化锂",
            port_definition={"制冷接口", "冷源接口", "蒸汽接口"},
            **kwargs,
        )
...
class 热水溴化锂(设备):
    def __init__(self, topo: 拓扑图, **kwargs):
        super().__init__(
            topo=topo,
            device_type="热水溴化锂",
            port_definition={"制冷接口", "冷源接口", "热水接口"},
            **kwargs,
        )
...
class 电热水锅炉(设备):
    def __init__(self, topo: 拓扑图, **kwargs):
        super().__init__(
            topo=topo, device_type="电热水锅炉", port_definition={"制热接口", "电接口"}, **kwargs
        )
...
class 天然气热水锅炉(设备):
    def __init__(self, topo: 拓扑图, **kwargs):
        super().__init__(
            topo=topo, device_type="天然气热水锅炉", port_definition={"燃料接口", "制热接口"}, **kwargs
        )
...
class 电解槽(设备):
    def __init__(self, topo: 拓扑图, **kwargs):
        super().__init__(
            topo=topo,
            device_type="电解槽",
            port_definition={"制氢接口", "设备余热接口", "电接口"},
            **kwargs,
        )
...
class 复合输水管道(设备):
    def __init__(self, topo: 拓扑图, **kwargs):
        super().__init__(
            topo=topo,
            device_type="复合输水管道",
            port_definition={"电接口", "冷输出接口", "热输出接口", "热输入接口", "冷输入接口"},
            **kwargs,
        )
...
class 复合水水换热器(设备):
    def __init__(self, topo: 拓扑图, **kwargs):
        super().__init__(
            topo=topo,
            device_type="复合水水换热器",
            port_definition={"冷输出接口", "热输出接口", "冷输入接口", "热输入接口"},
            **kwargs,
        )
